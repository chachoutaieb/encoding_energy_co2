...
usage :
	...
	python3 '/media/ridha/D81821F01821CE76/Doctorat/Projet4_Energy/CTC/codeP4/encoding_video.py'    -s '/media/ridha/D81821F01821CE76/Doctorat/Projet4_Energy/CTC/codeP4/original_dataset' -r '/media/ridha/D81821F01821CE76/Doctorat/Projet4_Energy/CTC/codeP4/encoding_results.xlsx' -m psnr ssim vmaf
                ...
                for c in codec_list:
                    for b in range(bitrateIndex[0], bitrateIndex[1]):
                        ...
                        if (otp == False or idv == None) :
                            ...
                            thread1.start()
                            t = time.time()
                            os.system("python3 "+self.project_path+"/energy.py  -s 0.3 -c 'FRA' -v '"+envid+"' > /dev/null 2>&1")
                            tf = time.time()-t
...
q = [9, 10]
bitrate_target = os.path.dirname(args["video_path"])+"/data/bitrate-final.xlsx"
video_info = os.path.dirname(args["video_path"])+"/data/video_information.xlsx"
